...
import static course.ServerDB.dmd;
...
public class ServerDB extends UnicastRemoteObject implements RemoteIF, History {
    ...
    public static String url = "jdbc:derby://localhost:1527/CompanyDB";
    public static Connection connectionDB = null;
    public static Statement stmt = null;  //prepared statement
    public static DatabaseMetaData dmd = null;
    public static ResultSet rs = null;
    
    public static String result;
 
    
   public static void main (String[] args) throws SQLException, RemoteException, InterruptedException, AlreadyBoundException 
    {
      //StartRMIServ();
      connectDB();
      //dropAllTables();
 ...
 */
   ...
   System.out.println("Connection to CompanyDB created");
    ...
    public static void createTablesCompanyDB() throws SQLException {
...
", CONSTRAINT eh_dismiss_ck CHECK (dismiss >= hire) ) ";
    ...
    public static boolean checkIfTableExists(final String tn) throws SQLException {
        ...
        rs = dmd.getTables(null, null, tn, null);
        boolean res = rs.next();
        rs.close();
        return res;
    }
